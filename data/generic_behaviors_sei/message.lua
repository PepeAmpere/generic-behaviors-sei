...
return {
    ["message"] = {
        ...
        ["SendOrder"] = function(receiver, btset, behaviorName, behaviorParameters, parentOrderData, presetName, overrides)
            self:SendMessage(
                receiver,
                "NewOrder",
                tableExt.Extend(
        ...
        ["ValidateOrderCompleted"] = function(fullMsg, behaviorName)
            if fullMsg.subject == "OrderCompleted" then
                ...
                return fullMsg.value.originalOrderData.behaviorName == behaviorName
            end
